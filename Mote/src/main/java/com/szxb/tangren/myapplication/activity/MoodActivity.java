 ...
 */
public class MoodActivity extends TakePhotoActivity {
    ...
    private void setFinish() {
        manager = LocalBroadcastManager.getInstance(MoodActivity.this);
...
//                    Toast.makeText(MoodActivity.this,title.getText().toString()+"\n"+content.getText().toString()+"\n"+imagePath,Toast.LENGTH_SHORT).show();
    ...
    public void takeSuccess(String imagePath) {
        ...
        ScannerByReceiver(MoodActivity.this, imagePath);
    }
